...
(function() {
  ...
  Tweak.Events = (function() {
    ...
    Events.prototype.addEvent = function(names, callback, context, max) {
      var event, ignore, item, j, k, len, len1, ref, ref1;
      if (context == null) {
        context = this;
      }
    ...
    Events.prototype.triggerEvent = function() {
      var context, event, item, j, k, len, len1, names, params, ref, ref1;
    ...
    Events.prototype.updateEvent = function(names, options) {
      var callback, calls, ctx, event, item, j, k, len, len1, listen, max, ref, ref1, reset;
      if (options == null) {
        options = {};
      }
      ctx = options.context;
  ...
  Tweak.View = (function(superClass) {
    ...
    View.prototype.template = function(data) {
      return (config.template ? Tweak.request(config.template) : Tweak.findModule(this.component.paths, './template'))(data);
    };
            ...
            for (j = 0, len = elements.length; j < len; j++) {
              ...
              if ((attachment != null) && !attachment.match(/\s+/)) {
                results1.push((function() {
                  ...
                  ref = Tweak.splitPath(attachment);
                  results2 = [];
                  for (k = 0, len1 = ref.length; k < len1; k++) {
                    val = ref[k];
                    val = Tweak.toAbsolute(this.component.parent.name || '');
                    if (name === val) {
                      child = prop;
                      break;
                    } else {
  ...
  Tweak.Components = (function(superClass) {
    ...
    Components.prototype.init = function() {
      var _absolute, _add, _extends, _paths, data, item, j, k, l, len, len1, len2, len3, n, name, obj, ref, ref1, ref2, ref3;
      this._data = [];
      data = [];
      _absolute = function(path) {
        return Tweak.toAbsolute(this.component.name, path);
      };
      _paths = function(paths) {
        var j, len, path, ref, results1;
        ref = Tweak.splitPath(paths);
        results1 = [];
        for (j = 0, len = ref.length; j < len; j++) {
          path = ref[j];
