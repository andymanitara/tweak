...
(function() {
  ...
  Tweak.Common = (function() {
    ...
    Common.splitPaths = function(paths) {
      var j, k, len, match, max, min, num, path, prefix, ref1, ref2, reg, results, suffix;
      reg = /^(.*)\[(\d*)(?:[,\-](\d*)){0,1}\](.*)$/;
      ...
      for (j = 0, len = paths.length; j < len; j++) {
        ...
        if (match != null) {
          ...
          for (num = k = ref1 = min || 0, ref2 = max || min; ref1 <= ref2 ? k <= ref2 : k >= ref2; num = ref1 <= ref2 ? ++k : --k) {
    ...
    Common.toAbsolute = function(context, relative) {
      var affixReg, amount, reduceReg, upReg;
      affixReg = /^(\.+[\/\\]*)+/;
      upReg = /^\.{2,}[\/\\]*/;
      amount = name.split(upReg).length - 1 || 0;
      reduceReg = RegExp("([\\/\\\\]*[^\\/\\\\]+){" + amount + "}[\\/\\\\]?$");
      return name.replace(affixReg, (context.replace(reduceReg, 1)) + "/");
    };
  ...
  Tweak.Events = (function() {
    ...
    Events.prototype.findEvent = function(names, build) {
      var event, events, item, j, len, results1;
      if (build == null) {
        build = false;
      }
            ...
            for (j = 0, len = elements.length; j < len; j++) {
              ...
              if ((attachment != null) && !attachment.match(/\s+/)) {
                results1.push((function() {
                  ...
                  ref1 = Tweak.Common.splitPath(attachment);
                  results2 = [];
                  for (k = 0, len1 = ref1.length; k < len1; k++) {
                    val = ref1[k];
                    val = Tweak.Common.toAbsolute(this.component.parent.name || '');
                    if (name === val) {
                      child = prop;
                      break;
                    } else {
  ...
  Tweak.Component = (function() {
    ...
    function Component(relation, options) {
      ...
      options.name = this.name = Tweak.Common.toAbsolute(this.parent.name || '', this.name);
  ...
  Tweak.Components = (function(superClass) {
    ...
    Components.prototype.init = function() {
      var _absolute, _add, _extends, _paths, data, item, j, k, l, len, len1, len2, len3, n, name, obj, ref1, ref2, ref3, ref4;
      this._data = [];
      data = [];
      _absolute = function(path) {
        return Tweak.Common.toAbsolute(this.component.name, path);
      };
      _paths = function(paths) {
        var j, len, path, ref1, results1;
        ref1 = Tweak.Common.splitPath(paths);
        results1 = [];
        for (j = 0, len = ref1.length; j < len; j++) {
          path = ref1[j];
  ...
  Tweak.Router = (function(superClass) {
    ...
    Router.prototype.__urlChanged = function(url) {
      var event, item, key, keys, match, ref1, res, results1, route, routes;
      url = url.replace(/^\/+|\/+$/g, '');
      ref1 = this.routes;
      results1 = [];
      for (event in ref1) {
        routes = ref1[event];
        results1.push((function() {
          var j, k, len, len1, ref2, results2;
          results2 = [];
