...
(function() {
  ...
  Tweak.Events = (function() {
    ...
    Events.prototype.addEvent = function(names, callback, context, max) {
      ...
      for (j = 0, len = ref1.length; j < len; j++) {
        ...
        if (toAdd) {
          event.__callbacks.push(context, callback, max, {
            calls: 0,
            listen: true
          });
        }
  ...
  Tweak.Store = (function(superClass) {
    ...
    function Store(_data) {
      this._data = _data != null ? _data : this.__base();
    }
    ...
    Store.prototype.set = function() {
      var data, key, name1, params, prev, prop, silent;
      data = arguments[0], silent = arguments[1], params = 3 <= arguments.length ? slice.call(arguments, 2) : [];
      ...
      for (key in data) {
        ...
        this._data[key] = (typeof this[name1 = "setter_" + key] === "function" ? this[name1].apply(this, [prop].concat(slice.call(params))) : void 0) || prop;
        if (!silent) {
    ...
    Store.prototype.get = function() {
      ...
      for (i = j = 0, len = limit.length; j < len; i = ++j) {
        item = limit[i];
        data = typeof this[name1 = "getter_" + key] === "function" ? this[name1].apply(this, params) : void 0;
        if (data == null) {
    ...
    Store.prototype.has = function(params) {
      var j, len, prop, res;
      res = this.get.apply(this, params);
